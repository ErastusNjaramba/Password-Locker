...
class User:
    ...
    def login(self):
        '''
        method that allows user to login credentials
        '''
...
if __name__ == "__main__":
    ...
    isTrue = True
    print("welcome .This is a python application that manages our passwords and even create new passwords for us.")
    while isTrue == True:
        print(
    ...
    while True:
        print("Would you like to procced?\n\n Use these shortcodes to proceed\n sav - Save new Credential \n shw - Display existing Credential\n see.acc - Find a credential \n del.acc -  Delete an existing Credential \n ext - Exit Application")
        shortCode = input().lower()
        if shortCode == 'sav':
            ...
            while True:
                print(
                    "my - You want to type your own password?\n ran -  generate random password")
